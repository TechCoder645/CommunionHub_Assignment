...
const HeroSection = () => {
  return (
    <section className="text-center px-6 py-16 bg-white relative overflow-hidden">
      {/* Main Heading */}
      <h1 className="text-4xl md:text-6xl font-extrabold text-black mt-8">
        Connect Communities
      </h1>
      ...
      <div className="flex flex-wrap justify-center items-center text-black font-bold text-2xl md:text-4xl mt-8 space-x-4">
        <div className="relative flex items-center">
          <img src={event1} alt="event 1" className="w-10 h-10 md:w-12 md:h-12 rounded-full mr-2 shadow-md" />
          Unite,
        </div>
        <div className="relative flex items-center">
          <img src={event2} alt="event 2" className="w-10 h-10 md:w-12 md:h-12 rounded-full mr-2 shadow-md" />
          Innovate,
        </div>
        Connect, Inspire
        <div className="relative flex items-center ml-3">
          <img src={event3} alt="event 3" className="w-10 h-10 md:w-12 md:h-12 rounded-full mr-2 shadow-md" />
          Together
        </div>
      </div>
      ...
      <div className="flex justify-center items-center mt-6">
        <div className="flex -space-x-2 bg-gray-100 px-4 py-2 rounded-full shadow-md">
          <img className="w-8 h-8 md:w-10 md:h-10 rounded-full border-2 border-white" src={event1} alt="User" />
          <img className="w-8 h-8 md:w-10 md:h-10 rounded-full border-2 border-white" src={event2} alt="User" />
      ...
      <div className="flex justify-center gap-6 mt-10">
        <motion.img
          src={event1}
          alt="Community 1"
          className="w-40 h-56 md:w-56 md:h-72 rounded-3xl object-cover shadow-lg"
          animate={{ y: [0, -15, 0] }}
